...
def apply_prc_iteration(
    ...
    new_problem, new_solution = extract_subpath_batch(origin_problem, current_tour, segment_indices, subpath_length)
...
def run_prc_loop(
    ...
    *,
    ...
    for step in range(num_iterations):
        ...
        best_tour = best_tour.roll(dims=1, shifts=int(torch.randint(low=0, high=problem_size, size=[1])[0]))
